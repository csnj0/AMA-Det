...
class SERIALGFLHead(AnchorHead):
    ...
    def _init_layers(self):
        ...
        self.reg_refine = DeformConv2dModule(self.feat_channels, self.feat_channels, [1, self.points], stride=[1, 1], padding=[0, self.points//2])
    ...
    def forward_single(self, x):
        ...
        cls_score = self.gfl_cls(self.cls_refine(cls_feat, offset_reg - dcn_base_offset)).sigmoid()
