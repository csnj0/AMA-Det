...
class RepPointsHead(AnchorFreeHead):
    ...
    def forward_single(self, x):
        ...
        dcn_offset = pts_out_init - dcn_base_offset
        ...
        if self.use_grid_points:
            ...
            pts_out_refine = pts_out_refine + pts_out_init

        # return cls_out, pts_out_init_2, pts_out_refine
    ...
    def loss_single(self, cls_score, pts_pred_init, pts_pred_refine, labels,
        ...
        return loss_cls, loss_pts_init * 0.0, loss_pts_refine
